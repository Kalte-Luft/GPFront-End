...
import {getProvinceOverview} from "../../../services/campaignService";

const InteractiveMap = ({ onProvinceSelect }) => {
    const svgRef = useRef(null);
    const [selectedProvince, setSelectedProvince] = useState(null);
    useEffect(() => {
        if(selectedProvince) {
            fetchProvinceOverview(selectedProvince);
        }
    }, [selectedProvince]);   
    const fetchProvinceOverview = async (provinceId) => {
        ...
        try {
            ...
            console.log("Error fetching province overview: ", error);
        }
    };
            ...
            <div className="map-content">
                ...
                <div className="map-box">
                    <svg
                        ...
                        xmlSpace="preserve"
                        ref={svgRef}
                        onClick={(e) => handleProvinceClick(e.target.id)}
                    >
                        <path
                            id="62"
                            fill="#EEEEEE"
