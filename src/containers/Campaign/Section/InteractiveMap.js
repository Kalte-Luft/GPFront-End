...
const InteractiveMap = () => {
    ...
    const library = [
        { id: "HoangSa", name: "Hoang Sa (Da Nang)", number: 65 },
        { id: "TruongSa", name: "Truong Sa (Khanh Hoa)", number: 64 },
        { id: "YenBai", name: "Yen Bai", number: 63 },
        { id: "VinhPhuc", name: "Vinh Phuc", number: 62 },
        { id: "VinhLong", name: "Vinh Long", number: 61 },
        { id: "TuyenQuang", name: "Tuyen Quang", number: 60 },
        { id: "TraVinh", name: "Tra Vinh", number: 59 },
        { id: "TienGiang", name: "Tien Giang", number: 58 },
        { id: "ThuaThienHue", name: "Thua Thien - Hue", number: 57 },
        { id: "ThanhHoa", name: "Thanh Hoa", number: 56 },
        { id: "ThaiNguyen", name: "Thai Nguyen", number: 55 },
        { id: "ThaiBinh", name: "Thai Binh", number: 54 },
        { id: "TayNinh", name: "Tay Ninh", number: 53 },
        { id: "SonLa", name: "Son La", number: 52 },
        { id: "SocTrang", name: "Soc Trang", number: 51 },
        { id: "QuangTri", name: "Quang Tri", number: 50 },
        { id: "QuangNinh", name: "Quang Ninh", number: 49 },
        { id: "QuangNgai", name: "Quang Ngai", number: 48 },
        { id: "QuangNam", name: "Quang Nam", number: 47 },
        { id: "QuangBinh", name: "Quang Binh", number: 46 },
        { id: "PhuYen", name: "Phu Yen", number: 45 },
        { id: "PhuTho", name: "Phu Tho", number: 44 },
        { id: "NinhThuan", name: "Ninh Thuan", number: 43 },
        { id: "NinhBinh", name: "Ninh Binh", number: 42 },
        { id: "NgheAn", name: "Nghe An", number: 41 },
        { id: "NamDinh", name: "Nam Dinh", number: 40 },
        { id: "LongAn", name: "Long An", number: 39 },
        { id: "LangSon", name: "Lang Son", number: 38 },
        { id: "LamDong", name: "Lam Dong", number: 37 },
        { id: "LaoCai", name: "Lao Cai", number: 36 },
        { id: "LaiChau", name: "Lai Chau", number: 35 },
        { id: "KomTum", name: "Kom Tum", number: 34 },
        { id: "KienGiang", name: "Kien Giang", number: 33 },
        { id: "KhanhHoa", name: "Khanh Hoa", number: 32 },
        { id: "HungYen", name: "Hung Yen", number: 31 },
        { id: "HoaBinh", name: "Hoa Binh", number: 30 },
        { id: "HoChiMinh", name: "Ho Chi Minh", number: 29 },
        { id: "HauGiang", name: "Hau Giang", number: 28 },
        { id: "HaiPhong", name: "Hai Phong", number: 27 },
        { id: "HaiDuong", name: "Hai Duong", number: 26 },
        { id: "HaTinh", name: "Ha Tinh", number: 25 },
        { id: "HaNoi", name: "Ha Noi", number: 24 },
        { id: "HaNam", name: "Ha Nam", number: 23 },
        { id: "HaGiang", name: "Ha Giang", number: 22 },
        { id: "GiaLai", name: "Gia Lai", number: 21 },
        { id: "DongThap", name: "Dong Thap", number: 20 },
        { id: "DongNai", name: "Dong Nai", number: 19 },
        { id: "DienBien", name: "Dien Bien", number: 18 },
        { id: "DakNong", name: "Dak Nong", number: 17 },
        { id: "DakLak", name: "Dak Lak", number: 16 },
        { id: "DaNang", name: "Da Nang", number: 15 },
        { id: "CanTho", name: "Can Tho", number: 14 },
        { id: "CaoBang", name: "Cao Bang", number: 13 },
        { id: "CaMau", name: "Ca Mau", number: 12 },
        { id: "BinhThuan", name: "Binh Thuan", number: 11 },
        { id: "BinhPhuoc", name: "Binh Phuoc", number: 10 },
        { id: "BinhDuong", name: "Binh Duong", number: 9 },
        { id: "BinhDinh", name: "Binh Dinh", number: 8 },
        { id: "BenTre", name: "Ben Tre", number: 7 },
        { id: "BacNinh", name: "Bac Ninh", number: 6 },
        { id: "BacGiang", name: "Bac Giang", number: 5 },
        { id: "BacCan", name: "Bac Can", number: 4 },
        { id: "BacLieu", name: "Bac Lieu", number: 3 },
    ...
    const displayProvince = (object) => {
        if (object) {
            return `<h2>${object.name}</h2><p>NO. ${object.number}</p>`;
        }
        return "";
    };
    ...
    useEffect(() => {
        ...
        // Gắn sự kiện click cho tất cả các path
