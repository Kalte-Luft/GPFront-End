            ...
            <div>
                {isOpenModalEditEmail && (
                    <Modal
                        ...
                        size="ml"
                    >
                        <ModalHeader toggle={() => this.toggle()}>We have sent you the code</ModalHeader>
                        <ModalBody>
                            <div className="modal-email-body">
                                <div className="input-container">
                                    <label>Before changing your account, you will need to enter the code we sent to {arrUsers && arrUsers.email ? arrUsers.email : ""}</label>
                                    <label
                                        style={{
                                            marginTop: "10px",
                                            fontWeight: "600",
                                    ...
                                    <input type="text" onChange={(event) => this.handleOnChangeInput(event, "name")} className="form-control" />
                                    <label
                                        style={{
                                            marginTop: "10px",
                                            color: "rgb(38, 38, 38)",
                                    ...
                                    >
                                        Didn't receive code? Resend in 22 seconds
                                    </label>
                                </div>
                            </div>
                        </ModalBody>
                    ...
                    <div className="your-account-content">
                        <div className="left-content">
                            ...
                            <div className="selection">
                                <div className="selection-content your-account-btn" onClick={() => this.scrollToSection(this.yourAccountRef)}>
                                    <div className="icon">
                                ...
                                <div className="selection-content security-btn" onClick={() => this.scrollToSection(this.securityRef)}>
                                    <div className="icon">
                                ...
                                <div className="selection-content donation-btn" onClick={() => this.scrollToSection(this.donationRef)}>
                                    <div className="icon">
                                ...
                                <div className="selection-content campaign-btn" onClick={() => this.scrollToSection(this.campaignRef)}>
                                    <div className="icon">
                            ...
                            <div className="right-container">
                                ...
                                <div className="security" ref={this.securityRef}>
                                        ...
                                        <div className="change-password-content">
                                            ...
                                            <div className="change-password-box">
                                                ...
                                                <div className="right">
                                                    <h1>Password</h1>
                                                    <p>
                                                        To add a password to your account for the first time, you'll need to use <a>the password reset page</a> so we can verify your identity.
                                                    </p>
                                                </div>
                                            </div>
                                            <hr class="_PhRSQ" />
                                    ...
                                    <div className="delete-account">
                                        ...
                                        <p>
                                            Once you delete your account, you won't be able to access your designs or log in to GreenPaws anymore. Your GreenPaws account was created at{" "}
                                            {formattedDateTime}.
                                        </p>
                                                ...
                                                <div key={index}>
                                                    <div className="product">
                                                        ...
                                                        <div className="product-info">
                                                            ...
                                                            <p>Purchased At: {new Date(item.createdAt).toLocaleDateString()}</p>
                                                            <p>x{item.quantity}</p>
                                                        </div>
                                ...
                                <div className="campaign" ref={this.campaignRef}>
                                    ...
                                    <div className="search">
                                        <div className="input-container">
                                            ...
                                            <input type="text" placeholder="Search by transaction code" className="form-control" />
                                        </div>
                                    </div>
                                                    ...
                                                    arrCampaignDonations.map((item, index) => {
                                                        return (
                                                            <tr key={index}>
                                                                ...
                                                                <td>{item.amount}đ</td>
                                                                <td>
                                                                    <i class="fa fa-info-circle" aria-hidden="true" onClick={() => this.handleNavigate("/detail/" + item.campaign_id)}></i>
                                                                </td>
                                                            </tr>
                                                        );
                                                    })}
